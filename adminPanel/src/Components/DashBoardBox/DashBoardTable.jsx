...
const DashBoardTable = () => {
  ...
  return (
    <>
      <div className="dashBoardTable mt-4 rounded-md bg-white shadow-md">
        ...
        <div className="mb-3 w-full overflow-x-auto">
          <table className="w- min-w-max table-auto text-left">
            <thead className="text-[16px]">
              <tr>
                <th className="border-primary border-b bg-[#f1f1f1] p-4">
              ...
              <tr className="hover:bg-primary/10">
                <td className="border-b border-slate-200 p-4">
                  <p className="block text-[rgba(0,0,0,0.7)]">
                    <Button
                      className="hover:!text-primary absolute right-1/4 ml-auto !h-[40px] !w-[40px] !min-w-[40px] !rounded-full bg-[#f1f1f1] !text-[16px] font-[600] !text-black"
                ...
                <td className="border-b border-slate-200 p-4">
                  <p className="text-primary block font-[600]">273848</p>
                </td>
                <td className="border-b border-slate-200 p-4 font-[400]">
                  <p className="text-primary block font-[600]">65423</p>
                </td>
                <td className="border-b border-slate-200 p-4">
                ...
                <td className="border-b border-slate-200 p-4">
                  <p className="text-primary block font-[600]">urb487gbwe</p>
                </td>
                <td className="border-b border-slate-200 p-4">
                  <p className="block text-[rgba(0,0,0,0.7)]">
                      ...
                      <table className="w- min-w-max table-auto text-left">
                        ...
                        <tbody className="text-[14px]">
                          <tr className="hover:bg-primary/10">
                            ...
                            <td className="border-b border-slate-200 p-4">
                              <p className="text-primary block font-[600]">
                                sdj7465zxbnf45
                              </p>
                            </td>
                            <td className="border-b border-slate-200 p-4">
