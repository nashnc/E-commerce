...
const CategoryListTable = () => {
  ...
  const subCate = ["title one", "title two", "title three"];
  const label = { inputProps: { "aria-label": "Checkbox demo" } };
  const image =
    "https://demos.codezeel.com/prestashop/PRS21/PRS210502/modules/cz_categoryimagelist/views/img/12-cz_categoryimagelist.jpg";
  return (
    <>
      <div className="dashBoardTable mt-4 rounded-md bg-white pb-3 shadow-md">
        <div className="px-5 py-5">
          <h3 className="text-[20px] font-[600]">Category List</h3>
        </div>
