            ...
            <tr className="hover:bg-primary/10">
              <td className="border-b border-slate-200 p-4">
                <p className="block text-[rgba(0,0,0,0.7)]">
                  <Button
                    className="absolute right-1/4 ml-auto !h-[40px] !w-[40px] !min-w-[40px] !rounded-full bg-[#f1f1f1] !text-[16px] !text-black hover:!text-primary"
              ...
              <td className="border-b border-slate-200 p-4">
                <p className="block font-[400] text-primary">273848</p>
              </td>
              <td className="border-b border-slate-200 p-4 font-[400]">
                <p className="block text-primary">65423</p>
              </td>
              <td className="border-b border-slate-200 p-4">
              ...
              <td className="border-b border-slate-200 p-4">
                <p className="block text-primary">urb487gbwe</p>
              </td>
              <td className="border-b border-slate-200 p-4">
                <p className="block text-[rgba(0,0,0,0.7)]">
                    ...
                    <table className="w- min-w-max table-auto text-left">
                      ...
                      <tbody className="text-[14px]">
                        <tr className="hover:bg-primary/10">
                          ...
                          <td className="border-b border-slate-200 p-4">
                            <p className="block text-primary">sdj7465zxbnf45</p>
                          </td>
                          <td className="border-b border-slate-200 p-4">
                            <p className="block text-[rgba(0,0,0,0.7)]">
                              Kurtha Paijama
...
export default MyOrdersRightTable;
