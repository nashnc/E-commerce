          ...
          <div className="col_2 w-[60%] pl-2">
            <ul className="nav flex items-center gap-3">
              <li className="list-none">
                <Link to="/" className="link text-[16px] font-[500] transition">
                  <Button className="link !font-[500] !text-[rgba(0,0,0,0.7)] transition hover:!text-[#ff5252]">
                    Home
                  </Button>
                </Link>
              </li>
              <li className="relative list-none">
                ...
                <div className="submenu absolute left-[0%] top-[120%] min-w-[ 150px] bg-white opacity-0 shadow-md transition-all">
                  <ul>
                    <li className="w-full list-none relative">
                      <Link to="/" className="w-full">
                        <Button className="w-full !justify-start !rounded-none !text-left !text-[rgba(0,0,0,0.7)]">
                          Men
                        </Button>
                        <div className="submenu absolute left-[0%] top-[100%] min-w-[ 150px] bg-white opacity-0 shadow-md transition-all">
                          <ul>
