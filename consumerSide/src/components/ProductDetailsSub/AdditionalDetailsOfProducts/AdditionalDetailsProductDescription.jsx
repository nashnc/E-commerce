    ...
    <>
      <div className="shadow-md w-full p-5  rounded-md">
        <div className=" productDescription">
          ...
          <p>
            Designed with a super light geometric case, the Versa family watches
            are slim, casual and comfortable enough to wear all day and night.
          ...
          <p>
            You will get 24 hour support with this purchase product and you can
