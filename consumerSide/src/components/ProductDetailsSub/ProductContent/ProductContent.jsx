               ...
               <div className="productContent">
                    <div className="pl-4">
                         ...
                         <div className="flex items-center gap-3">
                              <p className="text-[13px] opacity-75">
                                   ...
                                   <span className="font-[500] text-black">
                                        Men Collarless Solid Cotton Casual Gilet
                                        Jacket
                                   </span>
                              </p>
                              <ProductItemRating />
                         ...
                         <p className="mb-5 mt-3 pr-10 text-[14px] leading-[25px]">
                              Black casual jacket Collarless Gilet No sleeves
                              Straight hemline Polyester lining Size & Fit The
                              model (height 6') is wearing a size M Material &
                              Care Cotton Machine Wash Specifications Sleeve
                              Length Sleeveless Type Gilet Collar Collarless
                              Length Regular Closure Zip Lining Fabric Polyester
                              Number of Pockets 4 Hemline Straight Surface
                              Styling Zip Detail Surface Styling Zip Detail
                              Number of Items 1 Package Contains 1 Jacket
                         </p>
